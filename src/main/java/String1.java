...
public class String1
{
    ...
    public String middleThree(String str) {
        ...
        String midThree = str.substring(middle - 1, middle + 2);
        return midThree;
    }
    ...
    public String conCat(String a, String b) {
        ...
        if( b.length() >= 1 && a.substring(a.length()-1).equals(b.substring(0,1))){
            b1 = b.substring(1);
        }
    ...
    public String minCat(String a, String b) {
        ...
        if(a.length() > b.length()){
            a1 = a1.substring(a.length()-b.length());
        }else{
            b1 = b1.substring(b.length()-a.length());
        }
